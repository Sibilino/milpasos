...
<div>
    ...
    <div>
        <?= $form->field($model, 'groupIds')->dropDownList(ArrayHelper::map(Group::find()->all(), 'id', 'name'), ['multiple'=>true]) ?>
        <?= $form->field($model, 'danceIds')->dropDownList(ArrayHelper::map(Dance::find()->all(), 'id', 'name'), ['multiple'=>true]) ?>
